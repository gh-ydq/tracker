...
public class DeviceTrackerController {
	...
	@ResponseBody
	public WebJsonResult<List<DeviceResultDto>> findDeviceTracker(@RequestBody DeviceReqParamDto deviceReqParamDto){
		List<DataPackageLog> dataPackageLogs = dataPackageLogManage.queryDataPackageLog(UserContainer.getUserCode(), deviceReqParamDto.getDeviceCode());
